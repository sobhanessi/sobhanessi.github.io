...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ components_Aboutme)
});
...
;// CONCATENATED MODULE: ./public/database/aboutme.js

const aboutme = [
    {
        left: true,
        description: `I born and raise in a very high political family so there is no
    ...
    country which if we have it in Iran, there would be no doubt that
    all the countries around Iran can rise and therefore we will have
    democracy and less fundamentalists and jihadists in the middle-east.
    <br />
    I'm not writing this for just people to come every time and see who
    I am, but I'm just writing this for future references.
    <br />
    But let's get back to my childhood.
    <br />
    As I mentioned above, all my families and relatives are political
    activists either in the regime side or against the Mullah's regime
    of Iran. I remember my first impression of demonstrations which
    happened in 1997 in July which my city, Tehran, was completely
    locked down and too many people and especially students killed by
    regime. I was not in the age to digest everything that is happening,
    but I was seeing poeple are dying and getting shot by Basijis and
    Sepahis. Something like a lamp was turned on my mind which I was
    always asking that what is going on. but the most important thing
    here is that, on that time due to suppression of regime, we were not
    allowed to speak in the public or even in the school I couldn't able
    to share my feelings and thoughts because then we would be arrested
    and we could be isolated from the society and be put in the Evin
    prison, therefore, I didn't have any kind of friends to share all of
    these things and they couldn't really understand what and how do I
    feel.
    <br />
    But beside all of these political things, my first moment of working
    with computers happened at the age of 3 or 4. My uncle had a
    computer company on that time and he had some computers which was
    running by MS-DOS on that time and the computers had Floppy Disks
    and we had to command them by the shell to do what and that was
    amazing to me and I always wanted to learn about computers and be
    master on that. I need to mention here that I have some problems
    with my eyes, it is called Strabismus and I had done 3 times of hard
    surgery which were very difficult for me and due to this issue I had
    to close my right eye in order to strengthen my left eye. I remember
    I did it for 4 to 5 years. Because of this problem, my family was
    always against me to work with computers so you guess what happened!
    ;)`,
        color: colors_.deepOrange[300],
        title: "the begining",
        titleStyle: {}
    },
    {
        right: true,
        description: `From the age of 7 until 12 was a bit steady and nothing
    ...
    <br />`,
        color: colors_.lightGreen[300],
        title: "from 7 to 15",
        titleStyle: {}
    },
    {
        left: true,
        description: `In the age of 15, in 2009 I joined a high school called Roshd
    ...
    which I wanted to go for it.`,
        color: colors_.lightBlue[200],
        title: "from 15 to 19",
        titleStyle: {}
    },
    {
        right: true,
        description: `In the university, at the begining everything was going good but
    ...
    very notable ones that have impacted me so much.`,
        color: colors_.deepPurple[200],
        title: "from 19 till now",
        titleStyle: {}
    }, 
];
/* harmony default export */ const database_aboutme = (aboutme);

// EXTERNAL MODULE: ./public/theme/theme.js
var theme = __webpack_require__(3018);
;// CONCATENATED MODULE: ./pages/components/Aboutme.tsx
        ...
        children: database_aboutme?.map((am)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                children: [
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)(material_.Grid, {
                        ...
                        children: [
                            am.left && /*#__PURE__*/ jsx_runtime_.jsx(material_.Grid, {
                                item: true,
                                sm: 1,
                                xs: 1,
                                lg: 1,
                            ...
                            am.right && /*#__PURE__*/ jsx_runtime_.jsx(material_.Grid, {
                                item: true,
                                sm: 1,
                                xs: 1,
                                lg: 1,
