...
const aboutme = [{
  ...
  left: true,
  description: `From the age of 7 until 12 was a bit steady and nothing especiall happened actually. The only thing that happened which
    ...
    I really didn't have anybody on my side except my brother and my mother and for sure my grandmother. I was not able to talk to anybody about what it is going because people could abandon us and leave us behind.`,
  color: colors_.lightGreen[300],
  title: "from 7 to 15",
  titleStyle: {}
}, {
  left: true,
  description: `In the age of 15, in 2009 I joined a high school called Roshd which at the begining I didn't know what have I done so far but I'm going to explain that what happened.
    ...
    This loop was going on until I graduated from high school and I admitted for university but this time due to pressure of my family I chose the survey engineering instead of computer which I wanted to go for it.`,
  color: colors_.lightBlue[200],
  title: "from 15 to 19",
  titleStyle: {}
}, {
  left: true,
  description: `In the university, at the begining everything was going good but again after my friends realized that I political acitivist all of them abandon me and left me behind.
    ...
    The story of me is not finished. But here I just mentioned the very notable ones that have impacted me so much.`,
...
function Aboutme() {
  return /*#__PURE__*/external_react_default().createElement((external_react_default()).Fragment, null, database_aboutme?.map(am => /*#__PURE__*/external_react_default().createElement("div", {
    key: am.title
    ...
    key: am.title
  }, am.left && /*#__PURE__*/external_react_default().createElement(material_.Grid, {
    item: true,
    sm: 1,
    xs: 1,
    lg: 1,
    ...
    key: am.title
  }, am.title))), /*#__PURE__*/external_react_default().createElement(material_.Grid, {
    item: true,
    sm: 9,
    xl: 9,
    lg: 9,
  ...
  }, /*#__PURE__*/external_react_default().createElement(material_.Typography, {
    color: "white",
    variant: "body1",
    paragraph: true,
    fontFamily: theme/* FONT_FAMILY */.ut,
    whiteSpace: "pre-line"
  }, am.description))), /*#__PURE__*/external_react_default().createElement("br", null), /*#__PURE__*/external_react_default().createElement("br", null))));
}
