...
export const WhatsAppIcon: React.FC<IconSvgProps> = ({
    ...
    return (
        ...
        >
            <path
                clipRule="evenodd"
                d="M10 2C5.582 2 2 5.582 2 10c0 1.476.392 2.86 1.077 4.055L2 18l4.055-1.064A7.962 7.962 0 0 0 10 18c4.418 0 8-3.582 8-8s-3.582-8-8-8Zm-2.5 5c.18 0 .368.003.512.007.18.005.378.013.567.442.213.48.67 1.63.73 1.75.058.118.097.257.02.414-.078.157-.117.255-.234.392-.117.137-.246.306-.352.41-.117.118-.238.245-.103.48.136.235.602.992 1.293 1.607.888.79 1.637 1.034 1.872 1.151.234.118.37.098.506-.059.137-.156.585-.683.741-.918.157-.234.313-.196.528-.117.216.078 1.37.646 1.605.764.235.118.391.176.45.274.058.098.058.568-.137 1.116-.196.548-.98 1.018-1.41 1.077-.39.054-.881.077-1.42-.089-.328-.103-.748-.24-1.284-.47C7.187 13.18 5.5 11.2 5.372 11.035c-.127-.166-1.039-1.38-1.039-2.633 0-1.254.657-1.87.89-2.124.234-.254.508-.313.676-.313Z"
                fill="currentColor"
                fillRule="evenodd"
            />
        </svg>
...
export const TelegramIcon: React.FC<IconSvgProps> = ({
    ...
    return (
        ...
        >
            <path
                clipRule="evenodd"
                d="M2.47 9.465C6.867 7.54 9.83 6.27 11.36 5.655 15.55 3.9 16.419 3.604 16.988 3.594c.126-.002.408.029.59.177a.646.646 0 0 1 .208.415c.02.119.044.39.025.602-.222 2.336-1.183 8.004-1.672 10.621-.207 1.107-.614 1.478-1.008 1.514-.857.079-1.508-.567-2.338-1.112-1.299-.853-2.033-1.384-3.294-2.217-1.458-.961-.513-1.49.318-2.354.218-.226 4-3.665 4.076-3.976.009-.038.018-.18-.067-.255-.085-.075-.21-.05-.3-.029-.128.029-2.168 1.378-6.118 4.045-.579.398-1.103.592-1.572.582-.517-.011-1.51-.293-2.249-.533-.906-.295-1.626-.451-1.563-.952.033-.261.392-.528 1.076-.8Z"
                fill="currentColor"
                fillRule="evenodd"
            />
        </svg>
